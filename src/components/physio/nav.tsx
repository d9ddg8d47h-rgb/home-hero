...
import { Users, Dumbbell, ClipboardList, Settings, LogOut } from "lucide-react";
...
const links = [
  ...
  { href: "/physio/templates", label: "Templates", icon: ClipboardList, exact: false },
  ...
  return (
    <>
      <header className="sticky top-0 z-10 flex items-center justify-between border-b border-border bg-card/95 px-4 py-3 backdrop-blur">
        <Link href="/physio" className="flex items-center gap-2">
